...
class SGI:
  ...
  def __init__(
    ...
    surface_steps: int=100,
    debug: bool=False,
    window_zoom: float=1.0,
    window_position: list[float]=[0.0, 0.0, 0.0],
    window_normal: list[float]=[0.0, 0.0, -1.0],
    window_focus: list[float]=[0.0, 0.0, -2.0],
    window_up: list[float]=[0.0, 1.0, 0.0],
    window_movement_speed: int=10,
    window_rotation_speed: int=15,
    window_padding: int=15,
    line_clipping_algorithm: int=0,
    projection_type: int=1
  ):
